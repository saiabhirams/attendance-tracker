...
<html>
 <head>
  ...
  <script src="js/login.js"></script>
   <!-- Custom styles for this template -->
    ...
    <style>
    #logo {
      max-height: 30px; /* Set the maximum height for your logo */
 ...
 <body style="background-image: url('page1.jpg');">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"> <img src="logopic.jpg" alt="Your Logo" id="logo">Online Attendance</a>
        </div>
  ...
  <div class="container">
    <h2>For Students</h2>
    <h2>Click here for <a href="student.php"> Student Dashboard</a></h4>
    <hr>
    <h2 style="color:#191970;">For Faculty </h2>
    ...
    <table class="table table-bordered table-striped">
      <thead>
        <tr>
          <th style="color:#008080;">Login</th>
          <th style="color:#008080;">Sign Up</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td>
            <form id="login">
              <div class="form-group">
                <label style="color:#008080;">Email ID</label>
                <input class="form-control" placeholder="Email" type="email" name="email">
              </div>
              <div class="form-group">
                <label style="color:#008080;">Password</label>
          ...
          <td>
            <form id="signup">
              <div class="form-group">
                <label style="color:#008080;">Name</label>
                <input class="form-control" placeholder="Name" type="text" name="name">
              </div>
              <div class="form-group">
                <label style="color:#008080;">Phone Number</label>
              ...
              <div class="form-group">
                <label style="color:#008080;">Re-type Password</label>
